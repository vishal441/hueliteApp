            ...
            <View style={{ width: "100%" }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => {
                        return <FlatImage row={this.props.row} image={item.src} name={item.name} />
                    }}
                />
            </View>
        )
                    ...
                    <View style={{ height: "90%", alignItems: "center" }}>
                        ...
                        <View style={styles.modes}>
                            <ScrollView showsVerticalScrollIndicator={false}>
                                <VerticalImageList row="row-1" mode={"Scenes"} list={SCENCE_LIST} />
                                <VerticalImageList row="row-2" mode={"Shades"} list={SHADES_LIST} />
                                <VerticalImageList row="row-3" mode={"Modes"} list={MODE_LIST} />
                            </ScrollView>
                        </View>
                    </View>
                </View>
