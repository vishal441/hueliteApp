...
class Splash extends Component {
    ...
    async componentDidMount() {
        ...
        if (!userRes) console.log("name : ", userRes)
        this.props.deviceListAction(deviceListing)
        console.log("..........HUElite APP STARTS HERE..........")
        setTimeout(function() {
            if (!userRes) self.props.navigation.replace("Welcome")
            else if (deviceListing.length) self.props.navigation.navigate("Dashboard")
