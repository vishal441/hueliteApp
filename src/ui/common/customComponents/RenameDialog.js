...
import { Text, StyleSheet, TextInput, Platform, KeyboardAvoidingView } from "react-native"
...
export const RenameDialog = props => {
    ...
    return (
        <Dialog visible={isDialogVisile} dialogStyle={styles.dialogStyle} dialogTitle={dlgTitle}>
            <DialogContent style={{ height: 170 }}>
            ...
            <DialogFooter style={styles.dialogFooter} bordered={false}>
                <LinearGradient
                    ...
                    colors={["#86abf0", "#3d9df2", "#035afc"]}
                    style={{ width: 140, borderRadius: 30 }}>
                    <Button
                        title={btnName}
